...
test('roles protect management, migrate old accounts, and apply account changes to live sessions',async()=>{
 ...
 const call=(path,method='GET',body,cookie='')=>fetch(base+'/api'+path,{method,headers:{Origin:origin,'Content-Type':'application/json',Cookie:cookie},body:body===undefined?undefined:JSON.stringify(body)});
